...
function applaySelect2() {
    //select2
    $('.js-select2').select2();
    //revalidate Author input in book form when insert data
...
function onModalSuccess(row) {
    ...
    KTMenu.init();
    //May be cause error => KTMenu.initGlobalHandlers();
    /* */
    KTMenu.initHandlers();
}
...
$(document).ready(function () {
    ...
    //and reasign value from every element like (decripthion in book form ) to the hidden element to revalid the input
    ...
    //TinyMCE for textarea form input
    //if form have an element with this selector ...
    if ($('.js-tinymce').length > 0) {
